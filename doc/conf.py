...
# built documents.
project =   "OSVVM-Scripts"
author =    "Jim Lewis, Patrick Lehmann"        # versionInformation.Author
copyright = "Copyright 2026 The OSVVM Authors"  # versionInformation.Copyright
version =   "v0.1"                              # ".".join(versionInformation.Version.split(".")[:2])  # e.g. 2.3    The short X.Y version.
release =   "v0.1.0"                            # versionInformation.Version
...
htmlhelp_basename = "OSVVMScriptsDoc"
...
latex_documents = [
	( master_doc,
		"OSVVMScripts.tex",
		"The OSVVM-Scripts Documentation",
		"Jim Lewis, Patrick Lehmann",
		"manual"
	),
]
